# genpark-telephony-silence-latency-vad-calibrator-skill
...
**genpark-telephony-silence-latency-vad-calibrator-skill** is a deterministic, zero-dependency Python skill engineered for autonomous conversational voice agents, telephony IVR navigation, and real-time interruption arbitration.

> **Executive Capability**: Voice activity detection silence threshold calibrator (ElevenLabs / Deepgram)
...
result = client.calibrate_endpointing_threshold()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-telephony-silence-latency-vad-calibrator-skill": {
      "command": "python",
      "args": ["/path/to/genpark-telephony-silence-latency-vad-calibrator-skill/mcp_server.py"]
    }
  }
}
```
